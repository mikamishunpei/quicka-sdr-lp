  ...
  return (
    <div className="flex-1 max-w-7xl mx-auto px-6 pt-20 pb-24 relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
      ...
      >
        ...
        <h1 className="text-[32px] md:text-[40px] lg:text-[36px] xl:text-[42px] font-black text-gray-900 tracking-tighter leading-[1.3] md:leading-[1.2] mb-8 whitespace-nowrap">
          完全手離れで「予約」を増やす<br />
