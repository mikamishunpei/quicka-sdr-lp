...
export function InteractiveGlobe({
  className,
  size = 600,
  dotColor = "rgba(184, 134, 11, ALPHA)", // Quicka gold baseline
  arcColor = "rgba(184, 134, 11, 0.5)",
  markerColor = "rgba(218, 165, 32, 1)",
  ...
  const draw = useCallback(() => {
    ...
    glowGrad.addColorStop(0, "rgba(218, 165, 32, 0.03)");
