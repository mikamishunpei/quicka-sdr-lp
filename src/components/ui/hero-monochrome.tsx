              ...
              <React.Fragment key={step.title}>
                ...
                >
                  ...
                  <div className="px-2 pb-2">
                    ...
                    <h3 className={cn("block text-xl sm:text-2xl lg:text-xl xl:text-2xl font-black tracking-tighter relative z-10 leading-tight", isDark ? "text-white" : "text-gray-900")}>
                      {step.title}
                    </h3>
